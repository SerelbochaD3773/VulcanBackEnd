...
public class studentUseCase {
    ...
    // Propiedad
    private final List<Student> student; // Definicion Lista en memoria
    

    // Constructor
    public studentUseCase() {
        this.student = new ArrayList<>(); // Inicializacion - Preparar el uso de la lista.
    }
